...
urlpatterns = [
    ...
    path('mon-admin/commandes/', views.admin_commandes, name='admin_commandes'),
    path('mon-admin/commande/<int:pk>/first-delivery/', views.envoyer_first_delivery, name='envoyer_first_delivery'),
